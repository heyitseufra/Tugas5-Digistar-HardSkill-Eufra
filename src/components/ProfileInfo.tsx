...
const ProfileInfo: React.FC<ProfileInfoProps> = ({  
  ...
  return (  
    <div className="p-6 rounded-lg shadow-md bg-pink-50 max-w-4xl mx-auto h-full"> {/* Tambahkan h-full */}  
      <img  
        src="/images/kim-jungwoo.jpg"  
        alt="Profile"  
      ...
      <div className="flex justify-around my-6"> {/* Ganti my-6 dengan justify-around */}  
        ...
        <div className="flex flex-col items-center">  
          <h3 className="text-2xl font-bold text-black">2.5k</h3>  
          <p className="text-gray-600">Messages</p>  
        </div>  

        <div className="flex flex-col items-center">  
          <h3 className="text-2xl font-bold text-black">5.2k</h3>  
